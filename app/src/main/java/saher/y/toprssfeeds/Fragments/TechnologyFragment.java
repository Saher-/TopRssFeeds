...
public class TechnologyFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mSwipeRefreshLayout = (SwipeRefreshLayout) view.findViewById(R.id.technology_swipe_refresh_layout);
        mRecyclerView = (RecyclerView) view.findViewById(R.id.technology_recycler_view);
    ...
    private class GetTechnologyFeed extends AsyncTask<Void, Void, ArrayList<RssDataParser.Item>> {
        @Override
        protected ArrayList<RssDataParser.Item> doInBackground(Void... params) {
            try {
                return loadXmlFromNetwork("http://www.reuters.com/rssFeed/technologyNews");
            } catch (IOException e) {
