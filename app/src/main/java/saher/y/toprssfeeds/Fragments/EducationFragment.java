...
public class EducationFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mSwipeRefreshLayout = (SwipeRefreshLayout) view.findViewById(R.id.education_swipe_refresh_layout);
        mRecyclerView = (RecyclerView) view.findViewById(R.id.education_recycler_view);
    ...
    private class GetEducationFeed extends AsyncTask<Void, Void, ArrayList<RssDataParser.Item>> {
        @Override
        protected ArrayList<RssDataParser.Item> doInBackground(Void... params) {
            try {
                return loadXmlFromNetwork("http://www.npr.org/rss/rss.php?id=1013");
            } catch (IOException e) {
