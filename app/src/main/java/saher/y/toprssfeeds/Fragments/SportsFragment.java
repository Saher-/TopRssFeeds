...
public class SportsFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mSwipeRefreshLayout = (SwipeRefreshLayout) view.findViewById(R.id.sports_swipe_refresh_layout);
        mRecyclerView = (RecyclerView) view.findViewById(R.id.sports_recycler_view);
    ...
    private class GetSportsFeed extends AsyncTask<Void, Void, ArrayList<RssDataParser.Item>> {
        @Override
        protected ArrayList<RssDataParser.Item> doInBackground(Void... params) {
            try {
                return loadXmlFromNetwork("http://www.reuters.com/rssFeed/sportsNews");
            } catch (IOException e) {
