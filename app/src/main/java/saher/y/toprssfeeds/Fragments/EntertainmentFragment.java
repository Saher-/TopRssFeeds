...
public class EntertainmentFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mSwipeRefreshLayout = (SwipeRefreshLayout) view.findViewById(R.id.entertainment_swipe_refresh_layout);
        mRecyclerView = (RecyclerView) view.findViewById(R.id.entertainment_recycler_view);
        ...
        mSwipeRefreshLayout.setOnRefreshListener(new SwipeRefreshLayout.OnRefreshListener() {
            ...
            public void onRefresh() {
                ...
                new GetEntertainmentFeed().execute();
    ...
    private class GetEntertainmentFeed extends AsyncTask<Void, Void, ArrayList<RssDataParser.Item>> {
        @Override
        protected ArrayList<RssDataParser.Item> doInBackground(Void... params) {
            try {
                return loadXmlFromNetwork("http://www.npr.org/rss/rss.php?id=1045");
            } catch (IOException e) {
